#include <stout/nccl227.h>
#include <stout/tensor.h>
#include <stout/utils.cuh>
#include <stout/utils.h>
...
public:
  ...
  TVM_FFI_DECLARE_OBJECT_INFO_FINAL("stout.NCCLWrapper", NCCLWrapper,
                                    tvm::ffi::Object);
